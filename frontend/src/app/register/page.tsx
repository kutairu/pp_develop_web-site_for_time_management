  ...
  return (
    <div className="min-h-screen bg-[#0E1117] flex items-center justify-center relative overflow-hidden p-4 font-sans text-slate-300">
      ...
      <div className="w-full max-w-md bg-slate-900/60 backdrop-blur-md p-8 rounded-3xl border border-slate-800 shadow-2xl relative z-10">
        ...
        <h2 className="text-xl font-bold mb-6 text-center text-white">Регистрация профиля</h2>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          <div>
            <label className="block text-sm font-mono text-slate-400 mb-2">Имя пользователя</label>
            <input 
              type="text" required
        ...
        <p className="mt-8 text-center text-sm text-slate-500 font-mono">
          Уже есть аккаунт? <Link href="/login" className="text-blue-400 font-bold hover:text-blue-300 hover:underline transition-colors">Войти</Link>
        </p>
      </div>
    </div>
  );
